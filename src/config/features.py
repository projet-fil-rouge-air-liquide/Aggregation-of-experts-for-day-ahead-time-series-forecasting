...
day = ["P_curve_D","Wind_Norm_D","Wind_Norm_Cubes_NE_D","Wind_Norm_Cubes_NW_D",
       ...
       "wind_std_3h_D","wind_cv_3h_D","Wind_mean_3h_D","wind_std_3h_D"]
night = ["P_curve_N","Wind_Norm_N","Wind_Norm_Cubes_NE_N","Wind_Norm_Cubes_NW_N",
         ...
         "wind_std_3h_N","wind_cv_3h_N","Wind_mean_3h_N","wind_std_3h_N"]
lag = ["Y_lag_1h","Y_lag_24h","Wind_Norm_lag_24h"]
wind_variation = ["wind_std_3h","wind_cv_3h","Wind_mean_3h","wind_low","wind_med","wind_high"]
...
# expert global
GLOBAL = [f for f in cyclique + physique + lag if f not in ["Wind_Norm_Cubes","Y_lag_1h"]]
# Wind direction x4
WIND_ORIENTATION = cyclique + ["wind_std_3h", "Air_density"]
...
DAY = cyclique + day
NIGHT = cyclique + night

# - Experts Forces de vent(faible/fort/moyen)
WIND_LEVEL_LOW = cyclique + ["Air_density", "Y_lag_24h"] + ["wind_low", "wind_std_3h"]
WIND_LEVEL_MED = cyclique + ["Air_density", "Y_lag_24h"] + ["wind_med", "wind_std_3h"]
WIND_LEVEL_HIGH = cyclique + ["Air_density", "Y_lag_24h"] + ["wind_high", "wind_std_3h"]
