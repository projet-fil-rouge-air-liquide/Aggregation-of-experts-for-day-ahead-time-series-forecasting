...
print("RIDGE")
re = RidgeExpert()
results["ridge"] = recursive_forecast(re, use_scaler=True)
...
print("LGBM")
lgbm = LGBMExpert()
results["lgbm"] = recursive_forecast(lgbm, use_scaler=False)
...
results["elasticnet"] = recursive_forecast(ene, use_scaler=True)
